...
### Setting it up
1. Create a Terraform Cloud organization + workspace (VCS-driven or API-driven), and an AWS IAM role that GitHub Actions can assume via OIDC (no long-lived AWS keys needed).
2. In GitHub, set:
