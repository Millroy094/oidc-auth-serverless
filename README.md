...
3. In the Terraform Cloud workspace, set `support_email` and `domain_name` variables (see `infra/environments/production/variables.tf`). Leave `artifact_sha` as a placeholder — CI manages it.
